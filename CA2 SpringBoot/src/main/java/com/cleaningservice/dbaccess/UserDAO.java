        ...
        try (Connection conn = DBConnection.getConnection();
            ...
            try (ResultSet rs = stmt.executeQuery()) {
                while (rs.next()) {
                    ...
                    user.setAddress(rs.getString("Address"));
                    user.setContactNumber(rs.getString("ContactNumber"));
                    // Additional fields for sorting output
                    user.setTotalValue(rs.getDouble("TotalValue"));  // Assuming you added this to User class
                    user.setRegistrationDate(rs.getTimestamp("RegistrationDate")); // Assuming this too
                    user.setTotalActivity(rs.getInt("TotalActivity")); // Assuming this too
                    users.add(user);
                }
            }
